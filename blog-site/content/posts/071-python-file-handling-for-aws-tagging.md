...
date: 2024-05-17T03:19:57Z
slug: python-file-handling-for-aws-tagging
categories: ["Python"]
aliases: ["/post/71/"]
legacy_id: 71
---
In the previous post I developed shell script + awscli to apply aws EC2 tags, since the last post we discovered [Python Boto3](/posts/python-boto3-for-aws/) scripts for AWS resource automation and management, I think it is time to improve the EC2 tagging task with Python and boto3, together with file handling to achieve:
...
[![image tooltip here](/images/py2-1.png)](/images/py2-1.png)

Next, download and update 'ec2\_instances.csv' with all required tags, then rename and upload as 'ec2\_instances\_updated.csv', create second script "update1.py" to apply new tags:
...
[![image tooltip here](/images/py2-2.png)](/images/py2-2.png)
...
Export 2 CSV files for each AWS account based on given profile, update mandatory tags in the 2 CSV files, then upload and rename as \_updated\_:
...
Now create python script "update\_tags\_2.py" to apply new tags for 2 AWS accounts by given profile:
...
[![image tooltip here](/images/py2-3.png)](/images/py2-3.png)
[![image tooltip here](/images/py2-4.png)](/images/py2-4.png)
 **Conclusion**
