...
date: 2024-09-19T04:31:26Z
slug: eks-enable-iam-role-for-service-accounts-irsa
...
- Modify Application Code to Retrieve Secrets at Runtime, bellow python with boto3 can retrieve the `DB\_USER` and `DB\_PASSWORD` fields from the secret in AWS Secrets Manager
