...
date: 2024-08-15T04:17:55Z
slug: jenkins-multi-destination-cd-pipeline-with-terraform
categories: ["DevOps"]
aliases: ["/post/81/"]
legacy_id: 81
---
"Design a Jenkins pipeline can handle multiple destination: EC2, EKS across different environments"
...
[Jenkins - Universal CI Pipeline with Ansible & Terraform](/posts/jenkins-universal-ci-pipeline-with-ansible-terraform/)
...
- Jenkins CD pipeline with multi-stage
- Terraform to provision AWS EC2
- Ansible to configure docker and deploy blog
- Validate Web Blog Access
...
├── main.tf # the terraform file to provision AWS EC2
├── test-playbook.yaml # the playbook for Ansible testing and validation
└── variables.tf the terraform var file to provision AWS EC2
```
...
- Jenkins Cred and Environment Setup
- Check Installed Package Versions (AWSCli, Ansible, Terraform)
- Validate Ansible and AWS credential
- Run Terraform Initialization and Apply
- Validate EC2 Readiness and then Deploy Docker Using Ansible
- Validate Web Blog Access by extracting EC2 public IP
- Delete Terraform Resources
...
[![image tooltip here](/images/jenkins2.png)](/images/jenkins2.png)
...
[![image tooltip here](/images/jenkins3.png)](/images/jenkins3.png)
