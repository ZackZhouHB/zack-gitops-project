...
date: 2024-09-13T04:30:16Z
slug: eks-kubebench-and-opa-gatekeeper
...
In the last post, I was able to implement [EKS cluster autoscaler and Horizontal Pod Autoscaler (HPA)](/posts/eks-cluster-autoscaler-and-horizontal-pod-autoscaler-hpa/), in this post I will continue with EKS security practice with Kube-Bench and OPA Gatekeeper.
