---
title: "RedHat Identity Management (IdM) with AD Integration"
date: 2024-07-13T06:17:15Z
slug: redhat-identity-management-idm-with-ad-integration
categories: ["AWS"]
aliases: ["/post/101/"]
legacy_id: 101
---
...
- With AWS SSO Integration as external identity provider
...
- Host-Based Access Control (HBAC): RedHat IdM enforces HBAC rules to control which users can access specific EC2 instances.
...
[![image tooltip here](/images/idm3.png)](/images/idm3.png)

**Idm client Enrollment**

Now the idm web portal should be accessible, by adding "11.0.1.180 server1.ipa.zack.world" into local "c:/windows/system32/drivers/etc/hosts.
...
[![image tooltip here](/images/idm2.png)](/images/idm2.png)
...
[![image tooltip here](/images/idm1.png)](/images/idm1.png)
