...
```
<a href="/assets/mlops10-1.png" target="_blank">
    <img src="/assets/mlops10-1.png" alt="image tooltip here">
</a>
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: custom-ml
          image: 851725491342.dkr.ecr.ap-southeast-2.amazonaws.com/classifier-eks:latest
          resources:
            requests:
              nvidia.com/gpu: 1
...
<a href="/assets/mlops10-2.png" target="_blank">
    <img src="/assets/mlops10-2.png" alt="image tooltip here">
</a>
