---
layout: post
title:  " Python Boto3 for AWS Management  "
...
As I do not want to install Python, Boto3, and AWScli on my local PC, creating a docker image with all software ready as a portable way to start the Python environment anywhere is best.
