# Zack's Cloud, DevOps, and MLOps Portfolio

Welcome to my personal portfolio. I am a seasoned Senior Cloud Engineer with over a decade of experience in the IT industry, specializing in **AWS automation**, **Kubernetes (EKS) platform engineering**, and **Machine Learning Operations (MLOps)**. This repository is a living collection of my work, showcasing my journey from traditional IT to a cloud-native and MLOps-focused career.

My passion lies in building robust, scalable, and automated systems. I thrive on leveraging cloud-native architectures and modern DevOps practices to drive continuous improvement and solve complex challenges.

---

## 🚀 Core Competencies

*   **Cloud & DevOps:** AWS, Infrastructure as Code (Terraform, Ansible, CloudFormation), CI/CD, Serverless Architecture, Cost Optimization.
*   **Kubernetes & Containerization:** Kubernetes (EKS, Kubeadm), Docker, Helm, Argo CD, Karpenter, Istio, Container Security (CKS).
*   **MLOps & Data Science:** MLflow, DVC, PyTorch, AWS SageMaker, Data Engineering, Model Deployment & Serving.
*   **Automation & Scripting:** Python (Boto3), Bash, PowerShell.
*   **Backend & Web Development:** Django, Flask, REST APIs, Microservices.

---

## 📂 Project Highlights

This repository is organized into several key areas, each demonstrating a different facet of my skills and experience.
...
### 2. [GitOps and Kubernetes Projects](./gitops-k8s/)
...
*   **GitHub:** [ZackZhouHB](https://github.com/ZackZhouHB/zack-gitops-project/tree/editing)
*   **Credly:** [credly/zhou-zack](https://www.credly.com/users/zhou-zack/badges#credly/)
*   **My Blog:** [zackblog.work](https://zackblog.work)
